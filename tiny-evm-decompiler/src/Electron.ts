...
function createWindow() {
   ...
   ipcMain.on('load_example', async (event) => {
      const opcodes = new GetOpcodesInteractor().getOpcodes({
         contract: Buffer.from('', 'hex')
      })
      event.sender.send('contractOpcodes', JSON.stringify(opcodes));
